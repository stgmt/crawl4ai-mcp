...
class Settings:
    ...
    # Crawl4ai Backend
    CRAWL4AI_ENDPOINT: str = os.getenv(
        "CRAWL4AI_ENDPOINT", "https://stigmat-rudnev.crawl4ai-dev.fvds.ru"
    )
    ...
    # Authentication
    CRAWL4AI_BEARER_TOKEN: str | None = os.getenv("CRAWL4AI_BEARER_TOKEN")
